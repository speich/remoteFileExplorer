...
dojo.declare('rfe.StoreFileCache', null, {
	...
	put: function(item) {
		var self = this;
		return dojo.when(this.refPut.apply(this, arguments), function(id) {
	...
	add: function(item) {
		var self = this;
		return dojo.when(this.refNew.apply(this, arguments), function(newId) {
			item.id = newId
	...
	remove: function(id) {
		...
		return dojo.when(this.refDel.apply(this, arguments), function() {
...
//			console.log('new', newParentItem)
	...
	fetchItemByIdentity: function(args) {
		...
		var item;
		dojo.when(this.storeMemory.get(args.identity), function(result){
			item = result;
